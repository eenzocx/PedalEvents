<section id="redefinindo-senha" class="flex h-screen">
    ...
    <div class="hidden lg:block lg:w-1/2 lg:flex lg:items-center relative">
        <img class="absolute inset-x-0 w-[300rem]" src="./assets/img/undraw_writer_q06d.svg" alt="">
    </div>
    ...
    <div
        ...
        <p class="font-roboto text-3xl text-center mx-auto text-white font-bold mb-20">Digite sua nova senha</p>
